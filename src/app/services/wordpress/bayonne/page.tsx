...
const localInfo = {
  ...
  businessContext: 'Bayonne est une ville au riche patrimoine culturel et commercial. Les artisans, commerçants et professionnels du tourisme basque ont besoin de sites web reflétant leur identité.',
  sectors: ['Chocolaterie', 'Gastronomie basque', 'Artisanat', 'Tourisme', 'Commerce de centre-ville'],
  stats: [
    { value: '52K+', label: 'Habitants' },
    { value: '300K+', label: 'Habitants agglomération BAB' },
    { value: 'UNESCO', label: 'Patrimoine culturel' },
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les entreprises bayonnaises exigeantes. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans tout le ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking bayonnais pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans la chocolaterie, la gastronomie basque, l'artisanat et le tourisme. Nous comprenons les enjeux spécifiques des entreprises bayonnaises et du Pays Basque.`,
  },
]

export default function WordpressBayonnePage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les artisans et commerçants du Pays Basque dans leur transformation digitale.
            </p>
