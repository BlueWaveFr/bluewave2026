...
const localInfo = {
  ...
  businessContext: 'Arcachon et le Bassin attirent des millions de visiteurs chaque année. Les professionnels du tourisme, de l\'hôtellerie et de l\'ostréiculture ont besoin de sites web attractifs.',
  sectors: ['Tourisme et hôtellerie', 'Ostréiculture', 'Immobilier', 'Nautisme', 'Gastronomie'],
  stats: [
    { value: '10K+', label: 'Habitants' },
    { value: '4M', label: 'Visiteurs par an' },
    { value: '#1', label: 'Station balnéaire Gironde' },
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les professionnels du Bassin d'Arcachon. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et sur tout le Bassin d'Arcachon. Nous pouvons organiser des réunions dans vos locaux pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le tourisme, l'hôtellerie, l'ostréiculture, l'immobilier et le nautisme. Nous comprenons les enjeux spécifiques des professionnels du Bassin d'Arcachon.`,
  },
]

export default function WordpressArcachonPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les professionnels du tourisme et du Bassin dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Pessac', 'Libourne', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
