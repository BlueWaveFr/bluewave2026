...
const localInfo = {
  ...
  businessContext: 'Libourne est au cœur des prestigieuses appellations viticoles du Libournais. Les domaines viticoles et commerces locaux ont besoin de sites vitrines pour promouvoir leur activité.',
  ...
  stats: [
    ...
    { value: '1000+', label: 'Châteaux et domaines' },
    { value: 'UNESCO', label: 'Saint-Émilion classé' },
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les domaines viticoles du Libournais. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking libournais pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans la viticulture, le négoce, le tourisme œnotouristique et le commerce de centre-ville. Nous comprenons les enjeux spécifiques des domaines viticoles du Libournais.`,
  },
]

export default function WordpressLibournePage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les domaines viticoles et entreprises du Libournais dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Pessac', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
