...
const localInfo = {
  ...
  businessContext: 'Pau est une ville historique et dynamique qui attire de nombreuses entreprises. Le tissu économique local a besoin de sites web professionnels pour se développer.',
  ...
  stats: [
    ...
    { value: '200K+', label: 'Habitants agglomération' },
    { value: '#1', label: 'Vue sur les Pyrénées' },
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les entreprises paloises exigeantes. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans tout le ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking palois pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le commerce de centre-ville, le tourisme pyrénéen, la gastronomie béarnaise et les services aux entreprises. Nous comprenons les enjeux spécifiques des entreprises paloises.`,
  },
]

export default function WordpressPauPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les entreprises et commerçants du Béarn dans leur transformation digitale.
            </p>
