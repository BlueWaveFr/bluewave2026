...
const localInfo = {
  ...
  businessContext: 'Bordeaux est un hub économique majeur avec plus de 75 000 entreprises. La métropole bordelaise connaît une croissance exceptionnelle du digital, avec de nombreuses entreprises cherchant à renforcer leur présence en ligne.',
  sectors: ['Négoce de vins', 'Gastronomie et épicerie fine', 'Tourisme et œnotourisme', 'Immobilier', 'Services aux entreprises'],
  stats: [
    { value: '75K+', label: 'Entreprises dans la métropole' },
    { value: '2M', label: 'Habitants dans l\'agglomération' },
    { value: '+25%', label: 'Croissance digitale/an' },
    { value: '#2', label: 'Ville attractive de France' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les entreprises bordelaises exigeantes. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking bordelais pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le négoce de vins, la gastronomie, le tourisme et l'immobilier. Nous comprenons les enjeux spécifiques des entreprises bordelaises.`,
  },
]

export default function WordpressBordeauxPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les entreprises de la métropole bordelaise dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Mérignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
