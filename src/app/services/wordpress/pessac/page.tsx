...
const localInfo = {
  ...
  businessContext: 'Pessac abrite le campus universitaire de Bordeaux et les prestigieux vignobles de Pessac-Léognan. Les entreprises locales ont besoin de sites web modernes pour se démarquer.',
  sectors: ['Viticulture', 'Éducation', 'Commerce de proximité', 'Artisanat', 'Services'],
  stats: [
    { value: '65K+', label: 'Habitants' },
    { value: '60K', label: 'Étudiants sur le campus' },
    { value: 'Top 5', label: 'Appellations viticoles' },
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les entreprises pessacaises exigeantes. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking pessacais pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans la viticulture, l'éducation, le commerce de proximité et l'artisanat. Nous comprenons les enjeux spécifiques des entreprises pessacaises et du campus universitaire.`,
  },
]

export default function WordpressPessacPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les entreprises et viticulteurs de Pessac dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
