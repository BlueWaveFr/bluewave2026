...
const localInfo = {
  ...
  businessContext: 'Anglet est la plus grande ville de l\'agglomération BAB avec ses plages et sa forêt du Pignada. Les commerces et entreprises locales cherchent à développer leur visibilité en ligne.',
  sectors: ['Commerce de proximité', 'Surf et loisirs', 'Restauration', 'Artisanat', 'Services'],
  stats: [
    { value: '40K+', label: 'Habitants' },
    { value: '11', label: 'Plages de surf' },
    { value: '#1', label: 'Plus grande ville du BAB' },
...
const services = [
  ...
  },
  {
    ...
    description: `Développement de plugins personnalisés pour les entreprises d'${localInfo.city}. Fonctionnalités spécifiques, intégrations tierces et extensions sur mesure pour votre activité.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les entreprises angloyes exigeantes. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: `Support réactif pour les entreprises d'${localInfo.city}. Intervention rapide, mises à jour de sécurité et accompagnement personnalisé pour votre site WordPress.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans tout le ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking angloy pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le commerce de proximité, le surf et les loisirs, la restauration et l'artisanat. Nous comprenons les enjeux spécifiques des entreprises angloyes et de l'agglomération BAB.`,
  },
]

export default function WordpressAngletPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerces et entreprises de l'agglomération BAB dans leur transformation digitale.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-dark-300 text-lg max-w-2xl mx-auto">
              Un accompagnement complet pour les entreprises d'{localInfo.city} et sa région.
            </p>
          </motion.div>
