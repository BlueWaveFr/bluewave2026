...
const localInfo = {
  ...
  businessContext: 'Mérignac accueille l\'aéroport de Bordeaux et de nombreuses zones d\'activités. La ville compte plus de 10 000 entreprises qui ont besoin d\'une présence web professionnelle.',
  ...
  stats: [
    ...
    { value: '#2', label: 'Ville de Gironde' },
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les entreprises mérignacaises exigeantes. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking mérignacais pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans l'aéronautique, le commerce de proximité, les services aux entreprises et la santé. Nous comprenons les enjeux spécifiques des entreprises mérignacaises et de la zone aéroportuaire.`,
  },
]

export default function WordpressMerignacPage() {
  return (
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
