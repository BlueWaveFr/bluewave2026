...
const localInfo = {
  ...
  businessContext: 'Cognac est mondialement connue pour son eau-de-vie. Les maisons de cognac et les entreprises touristiques ont besoin d\'une vitrine digitale à la hauteur de leur prestige.',
...
const services = [
  ...
  },
  {
    ...
    description: `Architecture WordPress headless pour les maisons de cognac et entreprises de prestige. API REST, performances optimales et flexibilité totale pour votre front-end.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking cognaçais pour discuter de votre projet web.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans les maisons de cognac, la viticulture, le tourisme et l'artisanat de luxe. Nous comprenons les enjeux spécifiques des entreprises de prestige cognaçaises.`,
  },
]

export default function WordpressCognacPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les maisons de cognac et entreprises de la région dans leur transformation digitale.
            </p>
