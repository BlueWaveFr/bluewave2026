...
const localInfo = {
  ...
  department: '64',
  description: 'station balnéaire de renommée internationale sur la Côte Basque',
  businessContext: 'Biarritz est une destination de luxe attirant une clientèle internationale. Le e-commerce local se concentre sur le surf, la mode, le bien-être et les produits haut de gamme.',
  sectors: ['Surf et sports de glisse', 'Mode et prêt-à-porter', 'Hôtellerie de luxe', 'Bien-être et thalasso', 'Gastronomie haut de gamme'],
  stats: [
    { value: '25K+', label: 'Habitants' },
    { value: '4M+', label: 'Touristes/an' },
    { value: '#1', label: 'Spot de surf Europe' },
    { value: 'Premium', label: 'Marché cible' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients biarrots. Retrait en magasin, points relais locaux et livraison express sur la Côte Basque.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  {
    ...
    answer: `Travailler avec une agence locale à ${localInfo.city} vous permet de bénéficier d'un accompagnement de proximité, de réunions en présentiel et d'une parfaite connaissance du marché basque. Nous comprenons les spécificités du commerce de luxe et du tourisme sur la Côte Basque.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans tout le Pays Basque. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking biarrot pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le surf et sports de glisse, la mode, l'hôtellerie de luxe, le bien-être et la gastronomie haut de gamme. Nous comprenons les enjeux spécifiques du commerce biarrot.`,
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerçants et entreprises de la Côte Basque dans leur transformation digitale.
            </p>
