...
const localInfo = {
  ...
  department: '64',
  description: 'station balneaire de renommee internationale sur la Cote Basque',
  businessContext: 'Biarritz est une destination de luxe attirant une clientele internationale. Le e-commerce local se concentre sur le surf, la mode, le bien-etre et les produits haut de gamme.',
  sectors: ['Surf et sports de glisse', 'Mode et pret-a-porter', 'Hotellerie de luxe', 'Bien-etre et thalasso', 'Gastronomie haut de gamme'],
  stats: [
    { value: '25K+', label: 'Habitants' },
    { value: '4M+', label: 'Touristes/an' },
    { value: '#1', label: 'Spot de surf Europe' },
    { value: 'Premium', label: 'Marche cible' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients biarrots. Retrait en magasin, points relais locaux et livraison express sur la Cote Basque.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  {
    ...
    answer: `Travailler avec une agence locale a ${localInfo.city} vous permet de beneficier d'un accompagnement de proximite, de reunions en presentiel et d'une parfaite connaissance du marche basque. Nous comprenons les specificites du commerce de luxe et du tourisme sur la Cote Basque.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans tout le Pays Basque. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking biarrot pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans le surf et sports de glisse, la mode, l'hotellerie de luxe, le bien-etre et la gastronomie haut de gamme. Nous comprenons les enjeux specifiques du commerce biarrot.`,
  },
]

export default function PrestashopBiarritzPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commercants et entreprises de la Cote Basque dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Merignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
