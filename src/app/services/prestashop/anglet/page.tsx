...
const localInfo = {
  ...
  department: '64',
  description: 'ville dynamique entre ocean et foret au coeur de l\'agglomeration BAB',
  businessContext: 'Anglet beneficie d\'une situation privilegiee entre Bayonne et Biarritz. La ville accueille de nombreuses zones commerciales et un tissu d\'entreprises diversifie.',
  ...
  stats: [
    ...
    { value: '+15%', label: 'Croissance eco' },
    { value: 'BAB', label: 'Agglomeration' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Optimisation de votre referencement pour les recherches locales a ${localInfo.city} et dans les ${localInfo.region}. Visibilite accrue sur Google Maps et recherches geolocalisees.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients angloyes. Retrait en magasin, points relais locaux et livraison express dans l'agglomeration BAB.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans toutes les ${localInfo.region}. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans le commerce et distribution, le sport et loisirs, l'artisanat et les services aux particuliers. Nous comprenons les enjeux specifiques du commerce de l'agglomeration BAB.`,
  },
]
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: `Creation de boutiques PrestaShop a ${localInfo.city}. Expert e-commerce dans les ${localInfo.region}.`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commercants et entreprises de l'agglomeration BAB dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Merignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Pau'].map((city) => (
              <Link
                key={city}
