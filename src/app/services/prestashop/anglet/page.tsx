...
const localInfo = {
  ...
  department: '64',
  description: 'ville dynamique entre océan et forêt au cœur de l\'agglomération BAB',
  businessContext: 'Anglet bénéficie d\'une situation privilégiée entre Bayonne et Biarritz. La ville accueille de nombreuses zones commerciales et un tissu d\'entreprises diversifié.',
  sectors: ['Commerce et distribution', 'Sport et loisirs', 'Artisanat', 'Services aux particuliers', 'Immobilier'],
  stats: [
    { value: '40K+', label: 'Habitants' },
    { value: '11', label: 'Plages' },
    { value: '+15%', label: 'Croissance éco' },
    { value: 'BAB', label: 'Agglomération' },
  ],
}
...
const services = [
  ...
  {
    title: 'SEO Local Anglet',
    description: `Optimisation de votre référencement pour les recherches locales à ${localInfo.city} et dans les ${localInfo.region}. Visibilité accrue sur Google Maps et recherches géolocalisées.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients angloyes. Retrait en magasin, points relais locaux et livraison express dans l'agglomération BAB.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toutes les ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le commerce et distribution, le sport et loisirs, l'artisanat et les services aux particuliers. Nous comprenons les enjeux spécifiques du commerce de l'agglomération BAB.`,
  },
]

export default function PrestashopAngletPage() {
  return (
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: `Création de boutiques PrestaShop à ${localInfo.city}. Expert e-commerce dans les ${localInfo.region}.`,
            ...
            address: {
              ...
              postalCode: localInfo.department + '000',
              addressCountry: 'FR',
            },
            areaServed: {
              '@type': 'City',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerçants et entreprises de l'agglomération BAB dans leur transformation digitale.
            </p>
            ...
            >
              <div className="bg-dark-900/50 rounded-2xl border border-dark-800/50 p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-dark-400">et dans toutes les {localInfo.region}</p>
                </div>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Pau'].map((city) => (
              <Link
                key={city}
