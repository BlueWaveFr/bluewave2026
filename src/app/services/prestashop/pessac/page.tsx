...
const localInfo = {
  ...
  businessContext: 'Pessac est la troisieme ville de Gironde avec un tissu economique diversifie. La presence de l\'universite et des grandes ecoles favorise l\'innovation et les startups.',
  sectors: ['EdTech et formation', 'Commerce de proximite', 'Viticulture', 'Services numeriques', 'Sante et bien-etre'],
  stats: [
    { value: '65K+', label: 'Habitants' },
    { value: '60K+', label: 'Etudiants' },
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients pessacais. Retrait en magasin, points relais locaux et livraison express dans l'agglomeration.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking pessacais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans l'EdTech, le commerce de proximite, la viticulture et les services numeriques. Nous comprenons les enjeux specifiques du commerce pessacais et de son environnement universitaire.`,
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commercants et entreprises de cette ville universitaire dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Merignac', 'Libourne', 'Arcachon', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
