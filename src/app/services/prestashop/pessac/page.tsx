...
const localInfo = {
  ...
  region: 'Gironde',
  department: '33',
  description: 'ville universitaire dynamique aux portes de Bordeaux',
  businessContext: 'Pessac est la troisième ville de Gironde avec un tissu économique diversifié. La présence de l\'université et des grandes écoles favorise l\'innovation et les startups.',
  sectors: ['EdTech et formation', 'Commerce de proximité', 'Viticulture', 'Services numériques', 'Santé et bien-être'],
  stats: [
    { value: '65K+', label: 'Habitants' },
    { value: '60K+', label: 'Étudiants' },
    { value: '#3', label: 'Ville de Gironde' },
    { value: '+12%', label: 'Croissance digitale' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients pessacais. Retrait en magasin, points relais locaux et livraison express dans l'agglomération.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking pessacais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans l'EdTech, le commerce de proximité, la viticulture et les services numériques. Nous comprenons les enjeux spécifiques du commerce pessacais et de son environnement universitaire.`,
  },
]

export default function PrestashopPessacPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerçants et entreprises de cette ville universitaire dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Libourne', 'Arcachon', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
