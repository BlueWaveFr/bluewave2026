...
const localInfo = {
  ...
  businessContext: 'Bordeaux est un hub économique majeur avec plus de 75 000 entreprises. La métropole bordelaise connaît une croissance exceptionnelle dans le e-commerce, notamment dans les secteurs du vin, de la gastronomie et du luxe.',
  sectors: ['Négoce de vins', 'Gastronomie et épicerie fine', 'Mode et prêt-à-porter', 'Artisanat local', 'Tourisme et œnotourisme'],
  stats: [
    { value: '75K+', label: 'Entreprises dans la métropole' },
    { value: '2M', label: 'Habitants dans l\'agglomération' },
    { value: '+15%', label: 'Croissance e-commerce/an' },
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients bordelais. Retrait en magasin, points relais locaux et livraison express dans la métropole.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking bordelais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le négoce de vins, la gastronomie, le prêt-à-porter et l'artisanat local. Nous comprenons les enjeux spécifiques du commerce bordelais.`,
  },
]

export default function PrestashopBordeauxPage() {
  return (
