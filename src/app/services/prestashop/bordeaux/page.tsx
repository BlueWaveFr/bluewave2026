...
const localInfo = {
  ...
  businessContext: 'Bordeaux est un hub economique majeur avec plus de 75 000 entreprises. La metropole bordelaise connait une croissance exceptionnelle dans le e-commerce, notamment dans les secteurs du vin, de la gastronomie et du luxe.',
  sectors: ['Negoce de vins', 'Gastronomie et epicerie fine', 'Mode et pret-a-porter', 'Artisanat local', 'Tourisme et oenotourisme'],
  stats: [
    { value: '75K+', label: 'Entreprises dans la metropole' },
    { value: '2M', label: 'Habitants dans l\'agglomeration' },
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients bordelais. Retrait en magasin, points relais locaux et livraison express dans la metropole.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking bordelais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans le negoce de vins, la gastronomie, le pret-a-porter et l'artisanat local. Nous comprenons les enjeux specifiques du commerce bordelais.`,
  },
]
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Merignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
