...
const localInfo = {
  ...
  region: 'Gironde',
  department: '33',
  description: 'capitale du Libournais et porte d\'entree des vignobles de Saint-Emilion',
  businessContext: 'Libourne est un centre economique majeur du Libournais, reconnu pour son patrimoine viticole. La ville attire de nombreux commercants specialises dans le vin et la gastronomie.',
  sectors: ['Negoce de vins', 'Oenotourisme', 'Gastronomie', 'Commerce de centre-ville', 'Artisanat d\'art'],
  stats: [
    { value: '25K+', label: 'Habitants' },
    { value: '3K+', label: 'Entreprises' },
    { value: 'UNESCO', label: 'Juridiction classee' },
...
const faqs = [
  {
    ...
    answer: `Travailler avec une agence locale a ${localInfo.city} vous permet de beneficier d'un accompagnement de proximite, de reunions en presentiel et d'une parfaite connaissance du tissu economique libournais. Nous comprenons les specificites du marche local, notamment le negoce de vins et l'oenotourisme.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking libournais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans le negoce de vins, l'oenotourisme, la gastronomie et le commerce de centre-ville. Nous comprenons les enjeux specifiques du commerce libournais et de la region de Saint-Emilion.`,
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commercants et entreprises du Libournais dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Merignac', 'Pessac', 'Arcachon', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
