...
const localInfo = {
  ...
  region: 'Gironde',
  department: '33',
  description: 'capitale du Libournais et porte d\'entrée des vignobles de Saint-Emilion',
  businessContext: 'Libourne est un centre économique majeur du Libournais, reconnu pour son patrimoine viticole. La ville attire de nombreux commerçants spécialisés dans le vin et la gastronomie.',
  sectors: ['Négoce de vins', 'Œnotourisme', 'Gastronomie', 'Commerce de centre-ville', 'Artisanat d\'art'],
  stats: [
    { value: '25K+', label: 'Habitants' },
    { value: '3K+', label: 'Entreprises' },
    { value: 'UNESCO', label: 'Juridiction classée' },
    { value: '+18%', label: 'Tourisme/an' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients libournais. Retrait en magasin, points relais locaux et livraison express dans le Libournais.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  {
    ...
    answer: `Travailler avec une agence locale à ${localInfo.city} vous permet de bénéficier d'un accompagnement de proximité, de réunions en présentiel et d'une parfaite connaissance du tissu économique libournais. Nous comprenons les spécificités du marché local, notamment le négoce de vins et l'œnotourisme.`,
  },
  {
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toute la ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking libournais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans le négoce de vins, l'œnotourisme, la gastronomie et le commerce de centre-ville. Nous comprenons les enjeux spécifiques du commerce libournais et de la région de Saint-Emilion.`,
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerçants et entreprises du Libournais dans leur transformation digitale.
            </p>
            ...
            >
              <div className="bg-dark-900/50 rounded-2xl border border-dark-800/50 p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-dark-400">et dans tout le Libournais</p>
                </div>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Pessac', 'Arcachon', 'Bayonne', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
          ...
          >
            ...
            <div className="relative z-10 px-8 py-16 md:px-16 md:py-24 text-center">
              ...
              <p className="text-xl text-white/80 mb-10 max-w-2xl mx-auto">
                Discutons de votre projet e-commerce. Devis gratuit et personnalisé sous 48 h.
              </p>
