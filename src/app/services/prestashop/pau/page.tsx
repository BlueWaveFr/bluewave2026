...
const localInfo = {
  ...
  department: '64',
  description: 'préfecture des Pyrénées-Atlantiques et ville royale au pied des montagnes',
  businessContext: 'Pau est un pôle économique majeur du Sud-Ouest avec une forte présence dans l\'énergie, l\'aéronautique et les services. La ville développe activement son écosystème numérique.',
  sectors: ['Énergie et pétrochimie', 'Aéronautique', 'Tourisme de montagne', 'Commerce de centre-ville', 'Services numériques'],
  stats: [
    { value: '77K+', label: 'Habitants' },
    { value: '150K+', label: 'Agglomération' },
    { value: '#2', label: 'Ville de Nouvelle-Aquitaine' },
    { value: '+10%', label: 'Digital/an' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients palois. Retrait en magasin, points relais locaux et livraison express dans l'agglomération.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans toutes les ${localInfo.region}. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking palois pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans l'énergie, l'aéronautique, le tourisme de montagne et le commerce local. Nous comprenons les enjeux spécifiques du commerce palois.`,
  },
]

export default function PrestashopPauPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerçants et entreprises de l'agglomération paloise dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet'].map((city) => (
              <Link
                key={city}
