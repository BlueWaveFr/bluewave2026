...
const localInfo = {
  ...
  department: '64',
  description: 'prefecture des Pyrenees-Atlantiques et ville royale au pied des montagnes',
  businessContext: 'Pau est un pole economique majeur du Sud-Ouest avec une forte presence dans l\'energie, l\'aeronautique et les services. La ville developpe activement son ecosysteme numerique.',
  sectors: ['Energie et petrochimie', 'Aeronautique', 'Tourisme de montagne', 'Commerce de centre-ville', 'Services numeriques'],
  stats: [
    { value: '77K+', label: 'Habitants' },
    { value: '150K+', label: 'Agglomeration' },
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients palois. Retrait en magasin, points relais locaux et livraison express dans l'agglomeration.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans toutes les ${localInfo.region}. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking palois pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans l'energie, l'aeronautique, le tourisme de montagne et le commerce local. Nous comprenons les enjeux specifiques du commerce palois.`,
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commercants et entreprises de l'agglomeration paloise dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Merignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Bayonne', 'Biarritz', 'Anglet'].map((city) => (
              <Link
                key={city}
