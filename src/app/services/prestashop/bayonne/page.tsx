...
const localInfo = {
  ...
  department: '64',
  description: 'capitale du Pays Basque francais et ville d\'art et d\'histoire',
  businessContext: 'Bayonne est le coeur economique du Pays Basque francais avec un tissu commercial dynamique. La ville est reputee pour son chocolat, son jambon et son artisanat basque.',
  ...
  stats: [
    ...
    { value: '300K+', label: 'Agglomeration' },
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients bayonnais. Retrait en magasin, points relais locaux et livraison express dans l'agglomeration.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous deplacons regulierement a ${localInfo.city} et dans tout le Pays Basque. Nous pouvons organiser des reunions dans vos locaux ou dans un espace de coworking bayonnais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous a ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activite a ${localInfo.city}, avec une expertise particuliere dans la gastronomie basque, l'artisanat traditionnel, le commerce de centre-ville et le tourisme. Nous comprenons les enjeux specifiques du commerce bayonnais.`,
  },
]
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commercants et entreprises du Pays Basque dans leur transformation digitale.
            </p>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Merignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
