...
const localInfo = {
  ...
  department: '64',
  description: 'capitale du Pays Basque français et ville d\'art et d\'histoire',
  businessContext: 'Bayonne est le cœur économique du Pays Basque français avec un tissu commercial dynamique. La ville est réputée pour son chocolat, son jambon et son artisanat basque.',
  sectors: ['Gastronomie basque', 'Artisanat traditionnel', 'Commerce de centre-ville', 'Tourisme culturel', 'Sport et outdoor'],
  stats: [
    { value: '52K+', label: 'Habitants' },
    { value: '300K+', label: 'Agglomération' },
    { value: '#1', label: 'Ville du Pays Basque' },
    { value: '+20%', label: 'E-commerce/an' },
  ],
}
...
const services = [
  ...
  },
  {
    ...
    description: `Mise en place de solutions Click & Collect pour vos clients bayonnais. Retrait en magasin, points relais locaux et livraison express dans l'agglomération.`,
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
const faqs = [
  ...
  },
  {
    ...
    answer: `Oui, nous nous déplaçons régulièrement à ${localInfo.city} et dans tout le Pays Basque. Nous pouvons organiser des réunions dans vos locaux ou dans un espace de coworking bayonnais pour discuter de votre projet e-commerce.`,
  },
  {
    question: `Quels secteurs accompagnez-vous à ${localInfo.city} ?`,
    answer: `Nous accompagnons tous les secteurs d'activité à ${localInfo.city}, avec une expertise particulière dans la gastronomie basque, l'artisanat traditionnel, le commerce de centre-ville et le tourisme. Nous comprenons les enjeux spécifiques du commerce bayonnais.`,
  },
]

export default function PrestashopBayonnePage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-dark-300 leading-relaxed mb-8">
              ...
              Nous accompagnons les commerçants et entreprises du Pays Basque dans leur transformation digitale.
            </p>
            ...
            >
              <div className="bg-dark-900/50 rounded-2xl border border-dark-800/50 p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-dark-400">et dans tout le Pays Basque</p>
                </div>
      ...
      <section className="section-padding border-t border-dark-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            {['Bordeaux', 'Mérignac', 'Pessac', 'Libourne', 'Arcachon', 'Cognac', 'Biarritz', 'Anglet', 'Pau'].map((city) => (
              <Link
                key={city}
